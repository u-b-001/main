...
export const seed = async ({
  ...
  const serviceCardsData = [
    {
      title: 'Japanese Language Institute',
      excerpt:
        'Offering basic to advanced courses in Japanese, BJ-II, IJ, and AJ programs with certification.',
      link: '/japanese-language/about-institute',
    },
    {
      title: 'JLPT Examinations',
      excerpt:
        'MOSAI conducts the Japanese Language Proficiency Test in cooperation with the Japan Foundation.',
      link: '/examination-and-contest/jlpt-july-2026',
    },
    {
      title: 'EJU Examinations & Scholarship',
      excerpt:
        'Examination for Japanese University Admission for International Students andSAFJUAA scholarship guides.',
      link: '/examination-and-contest/eju-examination-and-scholarship',
    },
    {
      title: 'Study In Japan',
      excerpt:
        'Counselling cells and university information sessions for Indian students looking to study in Japan.',
      link: '/study-in-japan',
    },
  ]
  ...
  const eventsData = [
    {
      title: 'MOSAI All India Japanese Language Speech Contest',
      youtubeUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
      eventDate: '2026-03-15',
      organizer: 'Organized by MOSAI',
      description:
        'National level speech contest bringing outstanding speakers from all over India.',
      featured: true,
    },
    {
      title: 'Indo-Japan Academic & Cultural Ties Seminar',
      youtubeUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
      eventDate: '2026-05-10',
      organizer: 'Organized by MOSAI & Embassy of Japan',
      description:
        'A seminar discussing collaborative educational programs between Indian and Japanese universities.',
      featured: true,
    },
  ]
  ...
  const newsData = [
    {
      title: 'Admissions Open for Japanese Classes 2026',
      tag: 'ANNOUNCEMENT',
      excerpt: 'Registration for basic Japanese language course starts next Monday. Limited seats.',
      slug: 'admissions-open-2026',
      publishedAt: '2026-06-01T09:00:00.000Z',
      featured: true,
    },
    {
      title: 'JLPT July 2026 Schedule & Test Guide',
      tag: 'NOTICE',
      excerpt: 'Test schedules and admit card details for all exam centers are now available.',
      slug: 'jlpt-july-2026-schedule',
      publishedAt: '2026-06-10T10:00:00.000Z',
      featured: true,
    },
    {
      title: 'EJU Scholarships Results November 2025 Out',
      tag: 'RESULT',
      excerpt:
        'Check the official merit list of candidates selected for EJU Nov 2025 travel scholarships.',
      slug: 'eju-results-nov-2025',
      publishedAt: '2026-06-15T12:00:00.000Z',
      featured: false,
    },
    {
      title: 'Mitsui & Co. Scholarship Program 2026',
      tag: 'OPPORTUNITY',
      excerpt:
        'Applications are open for Mitsui scholarship program for Indian students who want to study in Japan.',
      slug: 'mitsui-scholarship-program-2026',
      publishedAt: '2026-06-18T14:00:00.000Z',
      featured: true,
    },
    {
      title: '37th All India Japanese Speech Contest Highlights',
      tag: 'EVENT',
      excerpt:
        'The contest was held at the India International Centre, New Delhi. Read highlights.',
      slug: 'speech-contest-highlights',
      publishedAt: '2026-06-20T16:00:00.000Z',
      featured: false,
    },
  ] as const
                ...
                children: [
                  {
                    ...
                    format: 0,
                    mode: 'normal',
                    text: `This is the full article content for ${news.title}. It has detailed reports and resources.`,
                    type: 'text',
                    version: 1,
                  },
                ],
  ...
  const committeeData = [
    {
      name: 'Dr. Ashok Chawla',
      role: 'President',
      designation: 'Advisor (Japan), MEA',
      type: 'committee',
      order: 1,
    },
    {
      ...
      designation: 'Former MEXT Scholar',
      type: 'committee',
      order: 2,
    },
    {
      ...
      designation: 'Professor of Japanese, JNU',
      type: 'advisory',
      order: 1,
    },
    {
      name: 'Sensei Keiko Tanaka',
      role: 'Head Faculty',
      designation: 'Native Japanese Language Instructor',
      type: 'faculty',
      order: 1,
    },
  ] as const
                ...
                children: [
                  {
                    ...
                    format: 0,
                    mode: 'normal',
                    text: `${member.name} serves as ${member.role} helping build Indo-Japanese academic bridges.`,
                    type: 'text',
                    version: 1,
                  },
                ],
                  ...
                  children: [
                    {
                      ...
                      format: 0,
                      mode: 'normal',
                      text: 'MOSAI (Mombusho Scholars Association of India) was established in 1989 as a society registered under the Societies Registration Act. It is an association of former recipients of the Mombusho (now MEXT) Scholarships of the Government of Japan.',
                      type: 'text',
                      version: 1,
                    },
                  ],
                  ...
                  children: [
                    {
                      ...
                      format: 0,
                      mode: 'normal',
                      text: 'The MOSAI Japanese Language Institute provides structured training for students and professionals looking to gain proficiency in the Japanese Language.',
                      type: 'text',
                      version: 1,
                    },
                  ],
                    ...
                    children: [
                      {
                        ...
                        format: 0,
                        mode: 'normal',
                        text: `Welcome to the ${title} page. This content is fully configurable via Payload CMS.`,
                        type: 'text',
                        version: 1,
                      },
                    ],
                      ...
                      children: [
                        {
                          ...
                          format: 0,
                          mode: 'normal',
                          text: 'We act as the nodal network for academic, cultural, and professional collaborations, providing university counseling and scholarship guidance for students aiming to study in Japan.',
                          type: 'text',
                          version: 1,
                        },
                      ],
      ...
      nav: [
        { label: 'Home', link: '/', openInNewTab: false },
        {
          ...
          children: [
            { label: 'The Association', link: '/about-mosai/the-association', openInNewTab: false },
            {
              ...
              link: '/about-mosai/presidents-message',
              openInNewTab: false,
            },
            {
              label: 'Managing Committee',
              link: '/about-mosai/managing-committee',
              openInNewTab: false,
            },
            {
              label: 'Association With SAFJUAA',
              link: '/about-mosai/association-with-safjuaa',
              openInNewTab: false,
            },
          ],
        },
        {
          ...
          children: [
            ...
            {
              label: 'Admission BJ-II/IJ/AJ',
              link: '/japanese-language/admission-for-bj2-ij-and-aj-session-2026',
              openInNewTab: false,
            },
            {
              label: 'Advisory Board & Faculty',
              link: '/japanese-language/advisory-board-and-faculty',
              openInNewTab: false,
            },
            {
              label: 'Course Content & Teaching Method',
              link: '/japanese-language/course-content-and-teaching-method',
              openInNewTab: false,
            },
            {
              label: 'Rules & Regulation',
              link: '/japanese-language/rules-and-regulation',
              openInNewTab: false,
            },
            {
              label: 'Placement Cell',
              link: '/japanese-language/placement-cell',
              openInNewTab: false,
            },
            {
              label: 'Admission In Basic Japanese',
              link: '/japanese-language/admission-in-basic-japanese',
              openInNewTab: false,
            },
          ],
        },
          ...
          children: [
            {
              ...
              subChildren: [
                {
                  label: 'Result EJU Nov 2025',
                  link: '/examination-and-contest/eju-examination-and-scholarship/eju-november-2025',
                },
              ],
            },
            {
              label: 'EJU June 2026',
              link: '/examination-and-contest/eju-june-2026',
              openInNewTab: false,
            },
            {
              label: 'EJU Travel Scholarship',
              link: '/examination-and-contest/eju-travel-scholarship',
              openInNewTab: false,
            },
            {
              label: 'JLPT July-2026',
              link: '/examination-and-contest/jlpt-july-2026',
              openInNewTab: false,
            },
            {
              label: 'Japanese Language Speech Contest (JLSC)',
              link: '/examination-and-contest/japanese-language-speech-contest-jlsc',
              openInNewTab: false,
            },
            {
              label: 'JLPT July-2026 Admit Card & Test Schedule',
              link: '/examination-and-contest/jlpt-july-2026-admit-card',
              openInNewTab: false,
            },
            {
              label: '37th All India JLSC',
              link: '/examination-and-contest/37th-all-india-jlsc',
              openInNewTab: false,
            },
          ],
        },
          ...
          children: [
            {
              ...
              link: '/study-in-japan/counselling-cell',
              openInNewTab: false,
            },
            {
              label: 'How to Join Japanese Universities',
              link: '/study-in-japan/how-to-join-japanese-universities',
              openInNewTab: false,
            },
            {
              label: 'Mitsui Scholarship Program-2026',
              link: '/study-in-japan/mitsui-scholarship-program-2026',
              openInNewTab: false,
            },
          ],
        },
          ...
          children: [
            {
              ...
              link: '/membership/becoming-a-member',
              openInNewTab: false,
            },
            {
        ...
        {
          label: 'Kizuna India-Japan Study Forum',
          link: '/kizuna-india-japan-study-forum',
          openInNewTab: true,
        },
      ],
    },
  ...
  await payload.updateGlobal({
    ...
    data: {
      ...
      contact: {
        ...
        address:
          'MOSAI Office, 102 First Floor, F-Block, Connaught Place, New Delhi - 110001, India',
      },
