...
export const MagicBento = ({
  ...
  const parsedGlowColor = hexToRgbString(glowColor || DEFAULT_GLOW_COLOR);
        ...
        {cards.map((card, index) => {
          ...
          const cardProps = {
            ...
            style: {
              ...
              '--glow-color-rgb': parsedGlowColor
            ...
            <>
              {card.image && (
                <>
                  <Image 
                    src={card.image} 
                    alt={card.alt || card.title || 'Bento Image'} 
                    fill 
              ...
              ref={el => {
                ...
                const handleClick = (e: MouseEvent) => {
                  ...
                  ripple.style.cssText = `
                    ...
                    height: ${maxDistance * 2}px;
                    border-radius: 50%;
                    background: radial-gradient(circle, rgba(${parsedGlowColor}, 0.4) 0%, rgba(${parsedGlowColor}, 0.2) 30%, transparent 70%);
                    left: ${x - maxDistance}px;
                    top: ${y - maxDistance}px;
                    pointer-events: none;
                    z-index: 1000;
