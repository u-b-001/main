  ...
  fields: [
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'Fullscreen Overlay (Split + Floating Card)', value: 'mosiaFullscreen' },
      ...
      fields: [
        ...
        },
        {
          ...
          admin: {
            condition: (_, siblingData) => siblingData?.enabled,
            components: {
              Field: '@/globals/OpacitySliderField#OpacitySliderField',
            },
    ...
    {
      type: 'group',
      name: 'mosiaFloatingCard',
      label: 'Floating Stats Card (Right Side)',
      admin: {
        condition: (_, siblingData) => siblingData?.layout === 'mosiaFullscreen',
      },
      fields: [
        {
          name: 'enabled',
